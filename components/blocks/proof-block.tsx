        ...
        <div className="container">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-1 items-stretch gap-6 lg:grid-cols-[1fr_auto_1fr] lg:gap-x-10">
            ...
            <div className="flex items-center justify-center py-1 lg:py-0">
              <div
                aria-hidden="true"
                className="from-site-background to-site-muted border-site-border relative flex size-14 items-center justify-center rounded-full border bg-linear-to-b shadow-[0_1px_2px_rgba(0,0,0,0.05),0_10px_22px_-6px_rgba(0,0,0,0.18)]"
              >
                <span className="pointer-events-none absolute inset-0 rounded-full bg-linear-to-b from-white/60 via-transparent to-transparent dark:from-white/8" />

...
export function ComponentsHeader() {
  ...
  return (
    <div className="border-site-border/80 bg-site-background sticky top-(--site-top-offset) z-10 flex h-12.75 items-center gap-2 border-b px-6 transition-[top] duration-140 ease-out motion-reduce:transition-none sm:px-8 xl:px-10">

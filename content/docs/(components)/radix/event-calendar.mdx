...
```bash
npx shadcn@latest add @neui/event-calendar
```

## Usage

```tsx
import { EventCalendar } from "@/components/neui/event-calendar/event-calendar"
import { EventCalendarContent } from "@/components/neui/event-calendar/event-calendar-content"
import { EventCalendarNav } from "@/components/neui/event-calendar/event-calendar-nav"
import type { CalendarEvent } from "@/components/neui/event-calendar/event-calendar-types"
```

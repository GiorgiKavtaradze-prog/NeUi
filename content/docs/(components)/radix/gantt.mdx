...
```bash
npx shadcn@latest add @neui/gantt
```

## Usage

```tsx
import { Gantt } from "@/components/neui/gantt/gantt"
import { GanttNav, GanttToolbar } from "@/components/neui/gantt/gantt-nav"
import type {
  GanttEvent,
  GanttResource,
} from "@/components/neui/gantt/gantt-types"
import { GanttView } from "@/components/neui/gantt/gantt-view"
```
